...
// UnmarshalUser parses the JSON-encoded data and stores the result
// in a User
...
// RegisterResponse is sent back to the front-end service after a new
// user tries to register for the ACME Serverless Fitness Shop
type RegisterResponse struct {
	// Message is a status message indicating success or failure
	Message string `json:"message"`

	// ResourceID represents the user that has been created
	// together with the new user ID
...
// UnmarshalRegisterResponse parses the JSON-encoded data and stores the result
// in a RegisterResponse
...
// Marshal returns the JSON encoding of RegisterResponse
func (r *RegisterResponse) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

// AllUsers is the response struct for the reply to
// the API call to get all users.
...
// UnmarshalLoginRequest parses the JSON-encoded data and stores the result
// in a LoginRequest
...
// LoginResponse is the response sent to the client to
// indicate whether or not the user has successfully authenticated
type LoginResponse struct {
	// Accesstoken is the JWT access token containing information
	// and claims
...
// UnmarshalLoginResponse parses the JSON-encoded data and stores the result
// in a LoginResponse
...
// UnmarshalVerifyTokenResponse parses the JSON-encoded data and stores the result
// in a VerifyTokenResponse
...
// UserDetailsResponse is sent back to the user with details
